...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // img = findViewById(R.id.logoImg);
        ...
        txtPass.setOnKeyListener((view, keyCode, keyEvent) -> {
          //  if (KeyEvent.getAction() == KeyEvent.ACTION_DOWN && keyCode == KeyEvent.KEYCODE_ENTER) {
                String userValue = Objects.requireNonNull(txtUser.getEditText()).getText().toString();
                String emailValue = txtUser.getEditText().getText().toString();
                String passValue = Objects.requireNonNull(txtPass.getEditText()).getText().toString();
