...
public class HomeActivity extends AppCompatActivity {
    ...
    private List<Model> getCities() {
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            allCities.add(new Model("Beni Sue", "5000 EGP", R.drawable.city2, "Beni Sue is the capital city of the Beni Sue Governorate in Egypt. Beni Sue is the location of Beni Sue University.[2] An important agricultural trade centre on the west bank of the Nile River, the city is located 110 km (70 miles) south of Cairo."));
